...
public class BaseParpareTestCrm {
	//输出本页面日志 初始化
	...
	protected static String testCrmUrl = "";
	...
	public void startTestPcUrl(ITestContext context){
		...
		testCrmUrl = context.getCurrentXmlTest().getParameter("testCrmUrl");
		method = "";
		
		try{
			//启动浏览器，打开浏览器，输入测试地址，并打开微信窗口
			seleniumUtil.launchBrowserPc(browserName, context, testCrmUrl, method,timeOut);
		}catch(Exception e){
