...
public class OCTD_WeiXinOneMonThreeAccount_001_TSF_Test extends BaseParpareTestAdmin {
	...
	@Test
	public void tenderFlowWeiXinOneMonth(){
		/**
		 * 初始化:投资流程
		 */
		//投资流程
		tenderFlowWeiXinPage_001_tenderSuccessFunction_test.tenderFlowWeiXinSuccessFunction
				(seleniumUtil,source,"100000.18","17999999943","111111",
						"223","900","5.85","加息券3.1%","9",
						"900","5.85","2.33","908.18");
		...
		tenderFlowWeiXinPage_001_tenderSuccessFunction_test.tenderFlowWeiXinSuccessFunction
				(seleniumUtil,source,"200000.18","17999999944","111111",
						"432","100","0.65","红包10.18元","1",
						"100","0.65","10.18","110.83");
		WeiXinLoginPageHelper.logOutWeiXin(seleniumUtil);
		seleniumUtil.get(TestUrl.getAdminURL() + "/portal/getRootMenu.htm");
		seleniumUtil.pause(1000);
		tenderFlowWeiXinPage_001_tenderSuccessFunction_test.tenderFlowWeiXinSuccessFunction
				(seleniumUtil,source,"300000.18","17999999945","111111",
						"433","49000","318.5","礼品券","490",
						"49000","318.5","0","49318.5");
		WeiXinLoginPageHelper.logOutWeiXin(seleniumUtil);
		//获得borrowId
...
//		String borrowId = "2247";
		...
		//我的--账户总览
		WeiXinAccountPreviewPageHelper.waitWeiXinAccountPreviewPageLoad(seleniumUtil,timeOut);
		WeiXinAccountPreviewPageHelper.typeWeiXinAccountPreviewPageInfo(seleniumUtil,"99,100.18","100,008.56","908.38","","0");
		//我的--我的投资
		seleniumUtil.get(TestUrl.getWXOldURL() + "/account/user/investment.htm");
		seleniumUtil.pause(1000);
		WeiXinAccountMyTenderPageHelper.waitWeiXinAccountMyTenderListPageLoad(seleniumUtil,timeOut);
		...
		//我的--账户总览
		WeiXinAccountPreviewPageHelper.waitWeiXinAccountPreviewPageLoad(seleniumUtil,timeOut);
		WeiXinAccountPreviewPageHelper.typeWeiXinAccountPreviewPageInfo(seleniumUtil,"199,900.18","200,011.04","110.86","","0");
		//我的--我的投资
		seleniumUtil.get(TestUrl.getWXOldURL() + "/account/user/investment.htm");
		seleniumUtil.pause(1000);
		WeiXinAccountMyTenderPageHelper.waitWeiXinAccountMyTenderListPageLoad(seleniumUtil,timeOut);
		...
		//我的--账户总览
		WeiXinAccountPreviewPageHelper.waitWeiXinAccountPreviewPageLoad(seleniumUtil,timeOut);
		WeiXinAccountPreviewPageHelper.typeWeiXinAccountPreviewPageInfo(seleniumUtil,"251,000.18","300,329.16","49,328.98","","0");
		//我的--我的投资
		seleniumUtil.get(TestUrl.getWXOldURL() + "/account/user/investment.htm");
		seleniumUtil.pause(1000);
		WeiXinAccountMyTenderPageHelper.waitWeiXinAccountMyTenderListPageLoad(seleniumUtil,timeOut);
